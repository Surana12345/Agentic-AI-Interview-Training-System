...
## Project Overview
This project presents a sophisticated Agentic AI-Driven Interview Training System that combines agentic AI orchestration with real-time posture tracking to provide comprehensive interview coaching. Situated strictly within the domains of **Generative AI** and **Agentic AI**, this system evaluates what you say, how you say it, and how you present yourself — all simultaneously.

Traditional interview preparation systems rely on scripted interactions, keyword-based evaluation, and one-dimensional feedback that cannot capture the full complexity of human communication. They lack agent-based interaction, debate simulations, and role-specific HR interview training. Most critically, they do not provide adaptive feedback or performance scoring aligned with real interview scenarios.

This system addresses every one of those limitations. It implements a true **multi-agent architecture** where independent AI agents work in parallel to analyze audio confidence, language quality, content relevance, and upper-body posture using **multimodal analysis**. A **deterministic scoring mechanism** computes performance metrics mathematically, while **Generative AI** (Google Gemini) is used **only** to interpret those scores and generate concise improvement feedback — ensuring explainability, consistency, and zero hallucination in grading.
...
Authors: Ching-Ta Lu, Yen-Yu Lu, Yi-Ru Lu, Ying-Chen Pan, Yu-Chun Liu
Journal: IEEE Open Journal of Instrumentation and Measurement, Vol. 4, 2025

Key Highlights:
- Proposes an AI-based English-speaking training system integrating generative avatars and speech recognition
- Continuously monitors learner attention and behavior to pause, adapt, or adjust lessons in real time
- Uses adaptive difficulty levels with keyword-spotting accuracy and response time to personalize speaking practice
- Experimental results show significant improvement in speaking accuracy, fluency, and learning efficiency over traditional methods
